...
int main(int argc, char **argv) {
    ...
    outputLF.mNumberOfViewColumns = NumberOfViewColumns;
    outputLF.mNumberOfViewLines = NumberOfViewLines;
...
/*                        
                        ...
                        int optimumSlant = hdt.DecodeInteger(8);
                        optimumSlant -= 128;
...
printf("optimumSlant = %d\n", optimumSlant);
			...
			pd.mPartitionData.Zeros();
                        ...
                        lfBlock.Zeros();			
                        //lfBlock.DeSlantMeanPadd(optimumSlant, optimumSlant, pd.mPartitionData);
                        lfBlock.DeSlant(optimumSlant, optimumSlant, pd.mPartitionData);
*/
                        lfBlock.Zeros();
			shd.mSlantMax = maximumSlant;
			shd.DecodeOptimumSlantTree(lfBlock, pd, IDCTarray, hdt);
